// 1. Index.html variables/functions
$('select').formSelect();
...
// 2. Creating global object for map markers that API lat/lon data will be pushed into
var image = {
...
//array to hold lat/lon data from API
/********************************************/
var latArray = [];
var lonArray = [];
/********************************************/
...
// 4. Once API is accessed, everything below is for Google Maps
